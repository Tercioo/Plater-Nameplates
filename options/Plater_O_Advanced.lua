...
function platerInternal.CreateAdvancedOptions()
    ...
    local advanced_options = {
        ...
        {type = "label", get = function() return "Selection Space Scaling:" end, text_template = DF:GetTemplate ("font", "ORANGE_FONT_TEMPLATE")},
        {
            ...
            thumbscale = 1.7,
            usedecimals = true,
            name = "Enemy Nameplate Click Space % (H)",
            desc = "The clickable area adjustment for the nameplate horizontally, relative to selected nameplate size, for enemy units.",
            nocombat = true,
            hidden = not IS_WOW_PROJECT_MIDNIGHT,
        },
        {
            ...
            thumbscale = 1.7,
            usedecimals = true,
            name = "Enemy Nameplate Click Space % (V)",
            desc = "The clickable area adjustment for the nameplate vertically, relative to selected nameplate size, for enemy units.",
            nocombat = true,
            hidden = not IS_WOW_PROJECT_MIDNIGHT,
        },
        {
            ...
            thumbscale = 1.7,
            usedecimals = true,
            name = "Friendly Nameplate Click Space % (H)",
            desc = "The clickable area adjustment for the nameplate horizontally, relative to selected nameplate size, for friendly units.",
            nocombat = true,
            hidden = not IS_WOW_PROJECT_MIDNIGHT,
        },
        {
            ...
            thumbscale = 1.7,
            usedecimals = true,
            name = "Friendly Nameplate Click Space % (V)",
            desc = "The clickable area adjustment for the nameplate vertically, relative to selected nameplate size, for friendly units.",
            nocombat = true,
            hidden = not IS_WOW_PROJECT_MIDNIGHT,
        },
        {
