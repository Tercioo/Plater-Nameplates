...
L["OPTIONS_ADVANCED_HEADER_GENERAL_SETTINGS"] = "General Settings:"
L["OPTIONS_ADVANCED_HEADER_CLIENT_SETTINGS_CVARS"] = "Client Settings (CVars):"
L["OPTIONS_ADVANCED_HEADER_OVERLAP_SIZE_SCALING"] = "Overlap Size Scaling:"
L["OPTIONS_ADVANCED_HEADER_NAMEPLATE_SELECTION_SPACE"] = "Nameplate Selection Space:"
L["OPTIONS_ADVANCED_HEADER_ENEMY_BOX_SELECTION_SPACE"] = "Enemy Box Selection Space:"
L["OPTIONS_ADVANCED_HEADER_FRIENDLY_BOX_SELECTION_SPACE"] = "Friendly Box Selection Space:"
L["OPTIONS_ADVANCED_HEADER_UNIT_TYPES"] = "Unit types:"
L["OPTIONS_ADVANCED_HEADER_BLIZZARD_NAMEPLATE_FONTS"] = "Blizzard nameplate fonts:"
L["OPTIONS_ADVANCED_HEADER_FONT_NORMAL"] = "Normal:"
L["OPTIONS_ADVANCED_HEADER_FONT_LARGE"] = "Large:"
L["OPTIONS_ADVANCED_HEADER_GLOBAL_OFFSET"] = "Global OffSet:"
L["OPTIONS_ADVANCED_HEADER_SPECIAL_UNITS"] = "Special Units:"
L["OPTIONS_ADVANCED_HEADER_REGION"] = "Region:"
L["OPTIONS_ADVANCED_HEADER_MISC"] = "Misc:"
L["OPTIONS_ADVANCED_HEADER_PERSONAL_BAR_CUSTOM_POSITION"] = "Personal Bar Custom Position:"
L["OPTIONS_ADVANCED_HEADER_ANIMATIONS"] = "Animations:"
L["OPTIONS_ADVANCED_HEADER_UNIT_WIDGET_BARS"] = "Unit Widget Bars:"

L["OPTIONS_ADVANCED_NAMEPLATE_ANCHOR_HEAD"] = "Head"
L["OPTIONS_ADVANCED_NAMEPLATE_ANCHOR_HEAD_DESC"] = "All nameplates are placed above the character."
L["OPTIONS_ADVANCED_NAMEPLATE_ANCHOR_HEAD_FEET"] = "Head/Feet"
L["OPTIONS_ADVANCED_NAMEPLATE_ANCHOR_HEAD_FEET_DESC"] = "Friendly and neutral has the nameplate on their head, enemies below the feet."
L["OPTIONS_ADVANCED_NAMEPLATE_ANCHOR_FEET"] = "Feet"
L["OPTIONS_ADVANCED_NAMEPLATE_ANCHOR_FEET_DESC"] = "All nameplates are placed below the character."

L["OPTIONS_ADVANCED_OUTLINE_MODE_NONE"] = "None"
L["OPTIONS_ADVANCED_OUTLINE_MODE_MONOCHROME"] = "Monochrome"
L["OPTIONS_ADVANCED_OUTLINE_MODE_OUTLINE"] = "Outline"
L["OPTIONS_ADVANCED_OUTLINE_MODE_THICK_OUTLINE"] = "Thick Outline"
L["OPTIONS_ADVANCED_OUTLINE_MODE_MONOCHROME_OUTLINE"] = "Monochrome Outline"
L["OPTIONS_ADVANCED_OUTLINE_MODE_MONOCHROME_THICK_OUTLINE"] = "Monochrome Thick Outline"

L["OPTIONS_ADVANCED_NUMBER_FORMAT_WESTERN"] = "Western (1K - 1KK)"

L["OPTIONS_ADVANCED_UPDATE_INTERVAL"] = "Update Interval"
L["OPTIONS_ADVANCED_UPDATE_INTERVAL_DESC"] = "Time interval in seconds between each update on the nameplate.\n\n|cFFFFFFFFDefault: 0.25|r (4 updates every second)."
L["OPTIONS_ADVANCED_QUICK_HIDE_ON_DEATH"] = "Quick Hide on Death"
L["OPTIONS_ADVANCED_QUICK_HIDE_ON_DEATH_DESC"] = "When the unit dies, immediately hide the nameplates without playing the shrink animation."
L["OPTIONS_ADVANCED_SHOW_HEALTHBARS_ON_NOT_ATTACKABLE_UNITS"] = "Show healthbars on not attackable units"
L["OPTIONS_ADVANCED_SHOW_HEALTHBARS_ON_NOT_ATTACKABLE_UNITS_DESC"] = "Show Healthbars on not attackable units instead of defaulting to 'name only'."
L["OPTIONS_ADVANCED_SHOW_SOFT_INTERACT_ON_GAME_OBJECTS"] = "Show soft-interact on game objects"
L["OPTIONS_ADVANCED_SHOW_SOFT_INTERACT_ON_GAME_OBJECTS_DESC"] = "Show soft-interact on game objects."
L["OPTIONS_ADVANCED_FORCE_NAMEPLATES_ON_SOFT_INTERACT_TARGET"] = "Force nameplates on soft-interact target"
L["OPTIONS_ADVANCED_FORCE_NAMEPLATES_ON_SOFT_INTERACT_TARGET_DESC"] = "Force show the nameplate on your soft-interact target."
L["OPTIONS_ADVANCED_ALWAYS_SHOW_SOFT_INTERACT_TARGET"] = "Always show soft-interact target"
L["OPTIONS_ADVANCED_ALWAYS_SHOW_SOFT_INTERACT_TARGET_DESC"] = "Always show the name or healthbar on your soft-interact target instead of hiding them on NPCs."
L["OPTIONS_ADVANCED_USE_BLIZZARD_SOFT_INTERACT_FOR_OBJECTS"] = "Use blizzard soft-interact for objects"
L["OPTIONS_ADVANCED_USE_BLIZZARD_SOFT_INTERACT_FOR_OBJECTS_DESC"] = "Only show Plater soft-interact nameplates on NPCs."
L["OPTIONS_ADVANCED_HIDE_PLATER_NAMES_GAME_OBJECTS"] = "Hide Plater names game objects"
L["OPTIONS_ADVANCED_HIDE_PLATER_NAMES_GAME_OBJECTS_DESC"] = "Hide Plater names game objects, such as soft-interact targets."
L["OPTIONS_ADVANCED_SHOW_SOFT_INTERACT_ICON"] = "Show soft-interact Icon"
L["OPTIONS_ADVANCED_SHOW_SOFT_INTERACT_ICON_DESC"] = "Show an icon on soft-interact targets."
L["OPTIONS_ADVANCED_KEEP_NAMEPLATES_ON_SCREEN"] = "Keep Nameplates on Screen"
L["OPTIONS_ADVANCED_KEEP_NAMEPLATES_ON_SCREEN_DESC"] = "Always keep nameplates on screen if the unit in combat with the player or a party member."
L["OPTIONS_ADVANCED_LOCK_TO_SCREEN_TOP_SIDE"] = "Lock to Screen (Top Side)"
L["OPTIONS_ADVANCED_LOCK_TO_SCREEN_TOP_SIDE_DESC"] = "Min space between the nameplate and the top of the screen. Increase this if some part of the nameplate are going out of the screen.\n\n|cFFFFFFFFDefault: 0.065|r\n\n|cFFFFFF00 Important |r: if you're having issue, manually set using these macros:\n/run SetCVar ('nameplateOtherTopInset', '0.065')\n/run SetCVar ('nameplateLargeTopInset', '0.065')\n\n|cFFFFFF00 Important |r: setting to 0 disables this feature."
L["OPTIONS_ADVANCED_LOCK_TO_SCREEN_BOTTOM_SIDE"] = "Lock to Screen (Bottom Side)"
L["OPTIONS_ADVANCED_LOCK_TO_SCREEN_BOTTOM_SIDE_DESC"] = "Min space between the nameplate and the bottom of the screen. Increase this if some part of the nameplate are going out of the screen.\n\n|cFFFFFFFFDefault: 0.065|r\n\n|cFFFFFF00 Important |r: if you're having issue, manually set using these macros:\n/run SetCVar ('nameplateOtherBottomInset', '0.1')\n/run SetCVar ('nameplateLargeBottomInset', '0.15')\n\n|cFFFFFF00 Important |r: setting to 0 disables this feature."
L["OPTIONS_ADVANCED_NAMEPLATE_OVERLAP_V"] = "Nameplate Overlap (V)"
L["OPTIONS_ADVANCED_NAMEPLATE_OVERLAP_V_DESC"] = "The space between each nameplate vertically when stacking is enabled.\n\n|cFFFFFFFFDefault: 1.10|r\n\n|cFFFFFF00 Important |r: if you find issues with this setting, use:\n|cFFFFFFFF/run SetCVar ('nameplateOverlapV', '1.6')|r"
L["OPTIONS_ADVANCED_NAMEPLATE_OVERLAP_H"] = "Nameplate Overlap (H)"
L["OPTIONS_ADVANCED_NAMEPLATE_OVERLAP_H_DESC"] = "The space between each nameplate horizontally when stacking is enabled.\n\n|cFFFFFFFFDefault: 0.8|r\n\n|cFFFFFF00 Important |r: if you find issues with this setting, use:\n|cFFFFFFFF/run SetCVar ('nameplateOverlapH', '0.8')|r"
L["OPTIONS_ADVANCED_MOVEMENT_SPEED"] = "Movement Speed"
L["OPTIONS_ADVANCED_MOVEMENT_SPEED_DESC"] = "How fast the nameplate moves (when stacking is enabled).\n\n|cFFFFFFFFDefault: 0.025|r\n\n|cFFFFFFFFRecommended: >=0.02|r"
L["OPTIONS_ADVANCED_GLOBAL_SCALE"] = "Global Scale"
L["OPTIONS_ADVANCED_GLOBAL_SCALE_DESC"] = "Scale all nameplates.\n\n|cFFFFFFFFDefault: 1|r"
L["OPTIONS_ADVANCED_MIN_SCALE"] = "Min Scale"
L["OPTIONS_ADVANCED_MIN_SCALE_DESC"] = "Scale applied when the nameplate is far away from the camera.\n\n|cFFFFFF00 Important |r: is the distance from the camera and |cFFFF4444not|r the distance from your character.\n\n|cFFFFFFFFDefault: 0.8|r"
L["OPTIONS_ADVANCED_LARGER_SCALE"] = "Larger Scale"
L["OPTIONS_ADVANCED_LARGER_SCALE_DESC"] = "Scale applied to important monsters (such as bosses).\n\n|cFFFFFFFFDefault: 1.2|r"
L["OPTIONS_ADVANCED_ANCHOR_POINT"] = "Anchor Point"
L["OPTIONS_ADVANCED_ANCHOR_POINT_DESC"] = "Where the nameplate is anchored to.\n\n|cFFFFFFFFDefault: Head|r"
L["OPTIONS_ADVANCED_SHOW_DEBUFFS_ON_BLIZZARD_HEALTH_BARS"] = "Show Debuffs on Blizzard Health Bars"
L["OPTIONS_ADVANCED_SHOW_DEBUFFS_ON_BLIZZARD_HEALTH_BARS_DESC"] = "While in dungeons or raids, if friendly nameplates are enabled it won't show debuffs on them.\nIf any Plater module is disabled, this will affect these nameplates as well."
L["OPTIONS_ADVANCED_ENEMY_NAMEPLATE_OVERLAP_PERCENT_H"] = "Enemy Nameplate Overlap % (H)"
L["OPTIONS_ADVANCED_ENEMY_NAMEPLATE_OVERLAP_PERCENT_H_DESC"] = "Scaling for the space each nameplate occupies horizontally when stacking is enabled, relative to clickspace, for enemy units."
L["OPTIONS_ADVANCED_ENEMY_NAMEPLATE_OVERLAP_PERCENT_V"] = "Enemy Nameplate Overlap % (V)"
L["OPTIONS_ADVANCED_ENEMY_NAMEPLATE_OVERLAP_PERCENT_V_DESC"] = "Scaling for the space each nameplate occupies vertically when stacking is enabled, relative to clickspace, for enemy units."
L["OPTIONS_ADVANCED_FRIENDLY_NAMEPLATE_OVERLAP_PERCENT_H"] = "Friendly Nameplate Overlap % (H)"
L["OPTIONS_ADVANCED_FRIENDLY_NAMEPLATE_OVERLAP_PERCENT_H_DESC"] = "Scaling for the space each nameplate occupies horizontally when stacking is enabled, relative to clickspace, for friendly units."
L["OPTIONS_ADVANCED_FRIENDLY_NAMEPLATE_OVERLAP_PERCENT_V"] = "Friendly Nameplate Overlap % (V)"
L["OPTIONS_ADVANCED_FRIENDLY_NAMEPLATE_OVERLAP_PERCENT_V_DESC"] = "Scaling for the space each nameplate occupies vertically when stacking is enabled, relative to clickspace, for friendly units."
L["OPTIONS_ADVANCED_LARGER_NAMEPLATES"] = "Larger Nameplates"
L["OPTIONS_ADVANCED_LARGER_NAMEPLATES_DESC"] = "Increases the blizzard base nameplate scaling (which is impacting the selection space and default blizzard nameplate size)."
L["OPTIONS_ADVANCED_BASE_VERTICAL_SCALE"] = "Base Vertical Scale"
L["OPTIONS_ADVANCED_BASE_VERTICAL_SCALE_DESC"] = "Increases the blizzard base nameplate scaling height (which is impacting the selection space and default blizzard nameplate size)."
L["OPTIONS_ADVANCED_BASE_HORIZONTAL_SCALE"] = "Base Horizontal Scale"
L["OPTIONS_ADVANCED_BASE_HORIZONTAL_SCALE_DESC"] = "Increases the blizzard base nameplate scaling height (which is impacting the selection space and default blizzard nameplate size)."
L["OPTIONS_ADVANCED_BASE_CLASSIFICATION_SCALE"] = "Base Classification Scale"
L["OPTIONS_ADVANCED_BASE_CLASSIFICATION_SCALE_DESC"] = "Increases the blizzard base nameplate classification scaling (which is impacting the selection space and default blizzard nameplate size)."
L["OPTIONS_ADVANCED_UNIT_SHOW_ENEMY_GUARDIANS"] = "Show Enemy Guardians"
L["OPTIONS_ADVANCED_UNIT_SHOW_ENEMY_GUARDIANS_DESC"] = "Show nameplates for enemies pets considered as guardian"
L["OPTIONS_ADVANCED_UNIT_SHOW_ENEMY_MINIONS"] = "Show Enemy Minions"
L["OPTIONS_ADVANCED_UNIT_SHOW_ENEMY_MINIONS_DESC"] = "Show nameplates for enemies considered as minions"
L["OPTIONS_ADVANCED_UNIT_SHOW_ENEMY_MINOR_UNITS"] = "Show Enemy Minor Units"
L["OPTIONS_ADVANCED_UNIT_SHOW_ENEMY_MINOR_UNITS_DESC"] = "Show nameplates of small units (usually they are units with max level but low health)"
L["OPTIONS_ADVANCED_UNIT_SHOW_ENEMY_PETS"] = "Show Enemy Pets"
L["OPTIONS_ADVANCED_UNIT_SHOW_ENEMY_PETS_DESC"] = "Show nameplates for enemy pets"
L["OPTIONS_ADVANCED_UNIT_SHOW_ENEMY_TOTEMS"] = "Show Enemy Totems"
L["OPTIONS_ADVANCED_UNIT_SHOW_ENEMY_TOTEMS_DESC"] = "Show enemy totems"
L["OPTIONS_ADVANCED_UNIT_SHOW_FRIENDLY_NPCS"] = "Show Friendly Npcs"
L["OPTIONS_ADVANCED_UNIT_SHOW_FRIENDLY_NPCS_DESC"] = "Show nameplates for friendly npcs"
L["OPTIONS_ADVANCED_UNIT_SHOW_FRIENDLY_GUARDIANS"] = "Show Friendly Guardians"
L["OPTIONS_ADVANCED_UNIT_SHOW_FRIENDLY_GUARDIANS_DESC"] = "Show nameplates for friendly pets considered as guardian"
L["OPTIONS_ADVANCED_UNIT_SHOW_FRIENDLY_MINIONS"] = "Show Friendly Minions"
L["OPTIONS_ADVANCED_UNIT_SHOW_FRIENDLY_MINIONS_DESC"] = "Show nameplates for friendly units considered minions"
L["OPTIONS_ADVANCED_UNIT_SHOW_FRIENDLY_PETS"] = "Show Friendly Pets"
L["OPTIONS_ADVANCED_UNIT_SHOW_FRIENDLY_PETS_DESC"] = "Show nameplates for friendly pets"
L["OPTIONS_ADVANCED_UNIT_SHOW_FRIENDLY_TOTEMS"] = "Show Friendly Totems"
L["OPTIONS_ADVANCED_UNIT_SHOW_FRIENDLY_TOTEMS_DESC"] = "Show friendly totems"
L["OPTIONS_ADVANCED_UNIT_SHOW_FRIENDLY_PLAYERS"] = "Show Friendly Players"
L["OPTIONS_ADVANCED_UNIT_SHOW_FRIENDLY_PLAYERS_DESC"] = "Show nameplates for friendly players"
L["OPTIONS_ADVANCED_ENABLE_BLIZZARD_NAMEPLATE_FONT_OVERRIDE_DESC"] = "Enable blizzard nameplate font override."
L["OPTIONS_ADVANCED_SHOW_HEALTH_PREDICTION_ABSORPTION"] = "Show Health Prediction/Absorption"
L["OPTIONS_ADVANCED_SHOW_HEALTH_PREDICTION_ABSORPTION_DESC"] = "Show an extra bar for health prediction and heal absorption."
L["OPTIONS_ADVANCED_SHOW_SHIELD_PREDICTION"] = "Show Shield Prediction"
L["OPTIONS_ADVANCED_SHOW_SHIELD_PREDICTION_DESC"] = "Show an extra bar for shields (e.g. Power Word: Shield from priests) absorption."
L["OPTIONS_ADVANCED_SETTING_REQUIRES_RELOAD"] = "this setting require a /reload to take effect."
L["OPTIONS_ADVANCED_MASQUE_SUPPORT"] = "Masque Support"
L["OPTIONS_ADVANCED_MASQUE_SUPPORT_DESC"] = "If the Masque addon is installed, enabling this will make Plater to use Masque borders.\n\n|cFFFFFF00 Important |r: require /reload after changing this setting."
L["OPTIONS_ADVANCED_NAME_TRANSLIT"] = "Name translit"
L["OPTIONS_ADVANCED_NAME_TRANSLIT_DESC"] = "Use LibTranslit to translit names. Changed names will be tagged with a '*'"
L["OPTIONS_ADVANCED_IN_OUT_COMBAT_USE_PLAYER_COMBAT_STATE"] = "In/Out of Combat Settings - Use Player Combat State"
L["OPTIONS_ADVANCED_IN_OUT_COMBAT_USE_PLAYER_COMBAT_STATE_DESC"] = "Use the players combat state instead of the units when applying settings for In/Out of Combat."
L["OPTIONS_ADVANCED_OPT_OUT_AUTO_ACCEPT_NPC_COLORS"] = "Opt-Out of automatically accepting NPC Colors"
L["OPTIONS_ADVANCED_OPT_OUT_AUTO_ACCEPT_NPC_COLORS_DESC"] = "Will not automatically accepd npc colors sent by raid-leaders but prompt instead."
L["OPTIONS_ADVANCED_AUTO_TRANSLATE_NPC_NAMES_ON_NPC_COLORS_TAB"] = "Automatically translate NPC names on the NPC Colors tab."
L["OPTIONS_ADVANCED_AUTO_TRANSLATE_NPC_NAMES_ON_NPC_COLORS_TAB_DESC"] = "Will automatically translate the names to the current game locale."
L["OPTIONS_ADVANCED_PERSONAL_BAR_TOP_CONSTRAINT_TEXT"] = "Plater: Top Constraint"
L["OPTIONS_ADVANCED_TOP_CONSTRAIN"] = "Top Constrain"
L["OPTIONS_ADVANCED_TOP_CONSTRAIN_DESC"] = "Adjust the top constrain position where the personal bar cannot pass.\n\n|cFFFFFFFFDefault: 50|r"
L["OPTIONS_ADVANCED_PERSONAL_BAR_BOTTOM_CONSTRAINT_TEXT"] = "Plater: Bottom Constraint"
L["OPTIONS_ADVANCED_BOTTOM_CONSTRAIN"] = "Bottom Constrain"
L["OPTIONS_ADVANCED_BOTTOM_CONSTRAIN_DESC"] = "Adjust the bottom constrain position where the personal bar cannot pass.\n\n|cFFFFFFFFDefault: 20|r"
L["OPTIONS_ADVANCED_ANIMATE_HEALTH_BAR"] = "Animate Health Bar"
L["OPTIONS_ADVANCED_ANIMATE_HEALTH_BAR_DESC"] = "Do a smooth animation when the nameplate's health value changes."
L["OPTIONS_ADVANCED_ANIMATE_COLOR_TRANSITIONS"] = "Animate Color Transitions"
L["OPTIONS_ADVANCED_ANIMATE_COLOR_TRANSITIONS_DESC"] = "Color changes does a smooth transition between the old and the new color."
L["OPTIONS_ADVANCED_HEALTH_BAR_ANIMATION_SPEED"] = "Health Bar Animation Speed"
L["OPTIONS_ADVANCED_COLOR_ANIMATION_SPEED"] = "Color Animation Speed"
L["OPTIONS_ADVANCED_ANIMATION_SPEED_DESC"] = "How fast is the animation."
L["OPTIONS_ADVANCED_WIDGET_BAR_SCALE_DESC"] = "Slightly adjust the size of widget bars."
L["OPTIONS_ADVANCED_WIDGET_BAR_ANCHOR_DESC"] = "Which side of the nameplate the widget bar should attach to."
L["OPTIONS_ADVANCED_OPTIONS_TITLE"] = "Advanced Options"
