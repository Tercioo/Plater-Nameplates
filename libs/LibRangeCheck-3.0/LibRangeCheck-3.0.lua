...
local HandSlotId = C_PaperDollInfo and C_PaperDollInfo.GetInventorySlotInfo and C_PaperDollInfo.GetInventorySlotInfo("HANDSSLOT") or GetInventorySlotInfo("HANDSSLOT")
