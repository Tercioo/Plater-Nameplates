...
function Plater.GetChangelogTable()
	if (not Plater.ChangeLogTable) then
		Plater.ChangeLogTable = {
			...
			{1603997229,  "Bug Fix", "October 29th, 2020", "Fixing issue with npc colors import not working."},
			{1603997229,  "Bachend Changes", "October 29th, 2020", "Enabling battle-pet healthbars in pet battles (friendly NPC options apply)."},
			{1603997229,  "Options Changes", "October 27th, 2020", "Adding an option to disable the '-AGGRO-' flash (off by default)."},
			{1603997229,  "Bug Fix", "October 26th, 2020", "Ensure mods/scripts are saved properly before exporting a profile."},
			{1603997229,  "Bug Fix", "October 26th, 2020", "Shortening spell-names in Russian locale now should work properly."},
			{1603997229,  "Bachend Changes", "October 25th, 2020", "'IsSelf' is now more consistent across the members."},
			{1603997229,  "Bachend Changes", "October 25th, 2020", "Proper alpha checks for the personal bar."},
			{1603997229,  "Bachend Changes", "October 25th, 2020", "Refresh settings tab when selecting it."},
			{1603997229,  "Bug Fix", "October 25th, 2020", "Stopping nameplate flash animations on nameplate removal."},
			{1603997229,  "Bug Fix", "October 24th, 2020", "Fixing an issue with internal aura sorting making auras too 'jumpy'."},
			{1603997229,  "Bug Fix", "October 24th, 2020", "Fixing an issue with LibCustomGlow implementation not recognizing the key properly in certain cases."},
			{1603997229,  "Bug Fix", "October 24th, 2020", "Fixing an issue with the Combo Points mod."},
			
			{1603997229,  "Bug Fix", "October 22nd, 2020", "Regression fixes for aura anchors and IsFocus."},
			{1603997229,  "Backend Changes", "October 22nd, 2020", "Adding 'upper range' execute ranges. (e.g. 100% to 80% for Warrior Condemn or 100% to 90% for Mage Firestarter)"},
			{1603997229,  "Backend Changes", "October 22nd, 2020", "Adding additional execute spells for WL, Rogue and Warriors."},
			{1603997229,  "Bug Fix", "October 21st, 2020", "Fixing 'Only Damaged Players' option."},
