...
function Plater.GetChangelogTable()
	if (not Plater.ChangeLogTable) then
		Plater.ChangeLogTable = {
			...
			{1720994680, "New Feature", "July 15th, 2024", "Adding option for Buff Special border thickness.", "cont1nuity"},
			{1720994680, "New Feature", "July 12th, 2024", "Added script  and mod option to select an audio to play.", "Terciob"},
			{1720994680, "New Feature", "July 11th, 2024", "Added 'hold shift to change all audios' with the same selected audio.", "Terciob"},
			{1720994680, "Bug Fix", "July 9th, 2024", "Fixing an issue BigWigs BossMod support.", "cont1nuity"},
			{1720994680, "Backend Change", "July 2nd, 2024", "Spell caching now filters out friendly units.", "Terciob"},
			{1720994680, "Backend Change", "July 1st, 2024", "Options panel improvements.", "Terciob"},
			{1720994680, "Backend Change", "July 1st, 2024", "Delay opening options menu when in combat to open after combat ends.", "cont1nuity"},
			{1720994680, "Bug Fix", "July 1st, 2024", "Fixing 'important' aura tracking.", "cont1nuity"},
			{1720994680, "Backend Change", "June 28th, 2024", "Performance units can now be disabled instead of removed.", "cont1nuity"},
			{1720994680, "Backend Change", "June 26th, 2024", "Preparations for scripts for TWW.", "Terciob"},
			{1720994680, "Backend Change", "June 26th, 2024", "Backend changes to NPC Colors tab.", "Terciob"},
			{1720994680, "Bug Fix", "June 25th, 2024", "Fixing an issue with mouse inputs on masqued cast icons.", "cont1nuity"},
